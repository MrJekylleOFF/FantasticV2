Locales['fr'] = {
  ...
  -- Menu Notification
  ['missing_rights'] = 'Vous n\'avez pas les droits',
  ...
  -- Loadout Menu
  ['loadout_title'] = 'Gestion de vos armes',
  ...
  ['wallet_job2_button'] = 'Faction: %s - %s',
  ...
  ['animation_party_salto'] = 'Faire un salto',
  ...
  ["animation_other_pipi"] = 'Faire pipi',
  ["animation_other_caca"] = 'Faire caca',
  ...
  -- Vehicle Menu
  ['vehicle_title'] = 'Gestion de votre véhicule',
  ...
  ['bossmanagement_title'] = 'Gestion de votre entreprise: %s',
