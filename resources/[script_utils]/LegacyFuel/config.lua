...
Config.Strings = {
	...
	EToRefuel = "~g~E ~w~pour faire le plein",
	JerryCanEmpty = "La Jerry can est vide",
	FullTank = "Votre véhicule est plein",
	PurchaseJerryCan = "~g~E ~w~Pour acheter un Jerry Can pour  ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "~g~E ~w~ Pour arrêter de remplir le véhicule",
	CancelFuelingJerryCan = "~g~E ~w~Pour arrêter de remplir",
	NotEnoughCash = "Vous n'avez pas assez d'argent",
	RefillJerryCan = "Press ~g~E ~w~Pour remplir la Jerry Can ",
	NotEnoughCashJerryCan = "Vous n'avez pas assez d'argent pour remplir la Jerry Can",
	JerryCanFull = "Le Jerry Can est plein ",
	TotalCost = "Prix",
}
