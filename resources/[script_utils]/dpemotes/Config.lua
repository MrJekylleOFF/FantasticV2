...
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = true,
	RagdollKeybind = 121, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Config.Languages = {
  ['en'] = {
        ...
        ['favoriteinfo'] = "Sélectionnez un emote ici pour le définir comme votre favoris.",
        ['rfavorite'] = "Réinitialiser le favoris",
  ...
  ['fr'] = {
        ...
        ['propemotes'] = "Props",
        ['favoriteemotes'] = "Favoris",
        ['favoriteinfo'] = "Définir un animations comme favoris.",
        ['rfavorite'] = "réinitialiser le favoris.",
        ['prop2info'] = "Prop animations peuvent être situés à la fin",
        ['set'] = "Set (",
        ['setboundemote'] = ") pour être votre animations lié?",
        ['newsetemote'] = "~w~ est maintenant votre animations liée, appuyez sur ~g~CapsLock~w~ pour l'utiliser.",
        ['cancelemote'] = "Annuler l'animation",
        ['cancelemoteinfo'] = "~r~X~w~ Annule l'animations en cours",
        ...
        ['suggestions'] = "Suggestions?",
        ['suggestionsinfo'] = "'dullpear_dev' sur les forums FiveM pour toutes les suggestions de fonction / Animations! ✉️",
		['notvaliddance'] = "n'est pas une danse valide",
        ['notvalidemote'] = "n'est pas une animations valide",
        ['nocancel'] = "Pas d'animations à annuler",
        ['maleonly'] = "Cet animations est réservé aux hommes, désolé!",
        ['emotemenucmd'] = "Do /emotemenu pour un menu",
        ['shareemotes'] = "Animations partagées",
        ['shareemotesinfo'] = "Inviter une personne proche à Animer",
        ['sharedanceemotes'] = "Dances partagées",
        ['notvalidsharedemote'] = "n'est pas un Animations partagé valide.",
        ['sentrequestto'] = "Demande envoyée à ~g~",
        ['nobodyclose'] = "Personne assez proche.",
        ['doyouwanna'] = "~y~Y~w~ accepter, ~r~L~w~ refuser (~g~",
        ['refuseemote'] = "Animations refusée.",
