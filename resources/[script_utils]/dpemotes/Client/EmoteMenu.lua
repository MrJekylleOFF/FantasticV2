...
local mainMenu = NativeUI.CreateMenu("Animation", "Faire une animation", 8, 200, '', '',nil, 100, 0, 0, 255)
...
function AddEmoteMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['emotes'],'', 8, 200, '', '',nil, 100, 0, 0, 255)
    local dancemenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['danceemotes'],'', 8, 200, '', '',nil, 100, 0, 0, 255)
    local propmenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['propemotes'],'', 8, 200, '', '',nil, 100, 0, 0, 255)
    ...
    if Config.SharedEmotesEnabled then
      sharemenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['shareemotes'], Config.Languages[lang]['shareemotesinfo'], 8, 200, '', '',nil, 100, 0, 0, 255)
      shareddancemenu = _menuPool:AddSubMenu(sharemenu, Config.Languages[lang]['sharedanceemotes'],'', 8, 200, '', '',nil, 100, 0, 0, 255)
      table.insert(ShareTable, 'none')
      table.insert(EmoteTable, Config.Languages[lang]['shareemotes'])

    end
    ee = _menuPool:AddSubMenu(submenu,"~r~--------------------------------","")
    table.insert(EmoteTable, 'none')
    ...
    if not Config.SqlKeybinding then
      ...
      favmenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['favoriteemotes'], Config.Languages[lang]['favoriteinfo'],'', 8, 200, '', '',nil, 100, 0, 0, 255)
...
function AddWalkMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['walkingstyles'],'', 8, 200, '', '',nil, 100, 0, 0, 255)
...
function AddFaceMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['moods'],'', 8, 200, '', '',nil, 100, 0, 0, 255)
