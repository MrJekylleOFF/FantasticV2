Locales['fr'] = {
  ...
  ['rent_vehicle']                    = 'concessionnaire - Avions en location',
  ['return_provider_menu']            = 'concessionnaire - Retour de véhicule',
  ['rental_amount']                   = 'contant de la location',
  ['sell_menu']                       = '~INPUT_CONTEXT~ pour vendre ~y~%s~s~ au prix de ~g~$%s~s~',
  ...
  ['shop_menu']                       = '~INPUT_CONTEXT~ pour accéder au menu',
  ['generic_shopitem']                = '$%s',
  ['vehicle_dealer']                  = 'concessionnaire - Avions',
