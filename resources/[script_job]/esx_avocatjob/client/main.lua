  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'boss_actions' then
        TriggerEvent('esx_society:openBossMenu1', 'avocat', function(data, menu)
          menu.close()
        end)
      end
...
local TeleportFromTo = {
	["Avocat"] = {
		positionFrom = { ['x'] = -1913.91, ['y'] = -574.77, ['z'] = 11.44, nom = "[~g~E~w~] Entrée"},
		positionTo = { ['x'] = -1902.43, ['y'] = -572.79, ['z'] = 19.1, nom = "[~g~E~w~] Sortie"},
	},	
}
