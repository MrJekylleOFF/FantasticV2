Locales['fr'] = {
  ...
  ['work_wear']                 = '~g~Prendre son service',
  ['civ_wear']                  = '~r~Prendre sa fin de service',
  ['deposit_stock']             = 'Déposer Stock',
  ['withdraw_stock']            = 'Prendre Stock',
  ['boss_actions']              = 'action Patron',
  ['opona_tools']               = 'Pneus',
  ['chiffon_tools']             = 'Chiffon',
  ...
  ['depanneur_stock']            = 'coffre de l\'entreprise',
  ['quantity']                  = 'quantité',
  ...
  ['depanneur_customer']         = 'client mosley',
