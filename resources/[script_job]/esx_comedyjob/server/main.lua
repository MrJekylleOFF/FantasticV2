...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'comedy', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'comedy', _U('comedy_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'comedy', 'comedy', 'society_comedy', 'society_comedy', 'society_comedy', {type = 'private'})



RegisterServerEvent('esx_comedyjob:getStockItem')
AddEventHandler('esx_comedyjob:getStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_comedy', function(inventory)
...
ESX.RegisterServerCallback('esx_comedyjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_comedyjob:putStockItems')
AddEventHandler('esx_comedyjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_comedyjob:getFridgeStockItem')
AddEventHandler('esx_comedyjob:getFridgeStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_comedy_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_comedyjob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_comedyjob:putFridgeStockItems')
AddEventHandler('esx_comedyjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_comedyjob:buyItem')
AddEventHandler('esx_comedyjob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_comedy', function(account)
...
RegisterServerEvent('esx_comedyjob:craftingCoktails')
AddEventHandler('esx_comedyjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_comedyjob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_comedy', function(store)
...
ESX.RegisterServerCallback('esx_comedyjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_comedyjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_comedyjob:getPlayerInventory', function(source, cb)
