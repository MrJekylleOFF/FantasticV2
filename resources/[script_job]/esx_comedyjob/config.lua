...
Config.AuthorizedVehicles = {
    { name = 'tornado4',  label = '~y~Vehicule pour les stagiaires'},
    { name = 'impaler',  label = '~r~Vehicule pour les employées 1'},
    { name = 'dominator',  label = '~r~Vehicule pour les employées 2'},
    { name = 'manchez',  label = '~r~Vehicule pour les employées 3 - ~y~MOTO'},
    { name = 'sultan',  label = '~o~Vehicule pour les agents de securités'},
    { name = 'rumpo3',  label = '~b~Vehicule pour la livraison'},
    { name = 'buffalo',  label = '~p~Vehicule pour le patron'},
}

Config.Blips = {
    
    Blip = {
      Pos     = { x = -434.34, y = 274.17, z = 83.42 },
      Sprite  = 304,
      Display = 4,
      Scale   = 0.8,
      Colour  = 8,
...
Config.Zones = {
    ...
    Vehicles = {
        Pos          = { x = -432.82, y = 259.72, z = 81.98 },
        SpawnPoint   = { x = -472.78, y = 267.39, z = 83.16 },
...
-------- SHOPS --------
    ...
    Flacons = {
        ...
        Items = {
            ...
            --{ name = 'sagres',      label = _U('sagres'),   price = 5 },
            --{ name = 'superbock',    label = _U('superbock'), price = 5 }
        },
    },

    NoAlcool = {
        Pos   = { x = -433.45, y = 273.15, z = 82.42 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        ...
        Items = {
            ...
            --{ name = 'sumol',       label = _U('sumol'), price = 8 }

        },
    },

    Apero = {
        Pos   = { x = -434.16, y = 275.07, z = 82.42 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        Color = { r = 142, g = 125, b = 76 },
        Type  = 23,
        Items = {
            { name = 'bolcacahuetes',   label = _U('bolcacahuetes'),    price = 7 },
            { name = 'bolnoixcajou',    label = _U('bolnoixcajou'),     price = 1 },
            { name = 'bolpistache',     label = _U('bolpistache'),      price = 1 },
            { name = 'bolchips',        label = _U('bolchips'),         price = 5 },
            { name = 'saucisson',       label = _U('saucisson'),        price = 2 },
            { name = 'grapperaisin',    label = _U('grapperaisin'),     price = 1 }
        },
    },

    Ice = {
        Pos   = { x = -474.59, y = 299.07, z = 82.26 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
