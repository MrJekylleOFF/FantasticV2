Locales['fr'] = {
    ...
    ['comedy_fridge_stock']     = 'Frigo du Comedy club',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique du Comedy club',
    ...
    -- Vehicles  
    ['vehicle_menu']             = '~r~Attention prenez le vehicule associé à votre grade',
    ...
    ['comedy_stock']             = 'Stock du Comedy club',
    ...
    ['not_enough']               = 'Vous n\'avez ~r~pas assez~s~ d\'argent ou ~g~ ',
    ['craft']                    = 'Mélange terminé de ~g~',

    -- Misc  
    ['map_blip']                 = 'Comedy club',
    ['comedy']                  = 'Comedy club',

    -- Phone  
    ['comedy_phone']            = 'Comedy club',
    ['comedy_customer']         = 'Citoyen',
