...
Config.NPCJobEarnings             = { min = 30, max = 45 }
...
Config.Zones = {
    MechanicActions = {
        Pos   = {x = -223.726, y = -1320.399, z = 29.89},
    ...
    Garage = {
        Pos   = {x = -199.71, y = -1319.887, z = 30.08},
        Size  = { x = 1.5, y = 1.5, z = 0.5 },
        Color = { r = 0, g = 0, b = 100 },
        Type  = 2,
    },
    ...
    Craft = {
        Pos   = {x = -197.389, y = -1320.43, z = 30.08},
    ...
    VehicleSpawnPoint = {
        Pos   = {x = -182.764, y = -1322.64, z = 30.28},
        Size  = { x = 1.5, y = 1.5, z = 0.5 },
        Type  = -1,
    },
    ...
    VehicleDelivery = {
        Pos   = {x = -212.78112792969, y = -1393.5368652344, z = 30.194892883301},
