...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('bav',0,'recruit','Recrue',20,'{}','{}'),
	('bav',1,'officer','Officier',40,'{}','{}'),
	('bav',2,'sergeant','Sergent',60,'{}','{}'),
	('bav',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('bav',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types_bav` (label, amount, category) VALUES
	...
	('Entrave opération de bav',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de bav',110,1),
