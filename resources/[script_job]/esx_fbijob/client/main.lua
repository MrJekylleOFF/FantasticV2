...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		table.insert(elements, {label = '~g~Tenue FBI 1', value = 'special_wear'})
		table.insert(elements, {label = '~g~Tenue FBI 2', value = 'executif_wear'})
		table.insert(elements, {label = '~g~Tenu Opération', value = 'responsable_wear'})
		...
		table.insert(elements, {label = '-------------------------------', value = ''})
		table.insert(elements, {label = '~g~Mettre Gilet', value = 'bullet_wear'})
		table.insert(elements, {label = '~r~Enlever Gilet', value = 'bullet1_wear'})
		--table.insert(elements, {label = 'Tenue FBI 4', value = 'boss_wear'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	{
		...
		if
			...
			data.current.value == 'responsable_wear' or
	...
	ESX.TriggerServerCallback('esx_fbijob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category',
		{
			...
			menu.close()
				...
				TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(player), 'society_fbi', _U('fine_total', label), amount)
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'fbi' then
				...
				elseif CurrentAction == 'menu_boss_actions' then
					if playerInService then 
						ESX.UI.Menu.CloseAll()
						TriggerEvent('esx_society:openBossMenu1', 'fbi', function(data, menu)
							menu.close()
							CurrentAction     = 'menu_boss_actions'
							CurrentActionMsg  = _U('open_bossmenu')
							CurrentActionData = {}
