...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'bowling' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function setUniform(job, playerPed)
  TriggerEvent('skinchanger:getSkin', function(skin)
    ...
    if skin.sex == 0 then
      ...
      if job ~= 'citizen_wear' and job ~= 'bowling_outfit' then
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('bowling_outfit'),    value = 'bowling_outfit'},
  }
    ...
    function(data, menu)
      ...
      if data.current.value == 'citizen_wear' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
          ...
          print("SERVICE OFF")
          TriggerServerEvent("player:serviceOff", "bowling")
          ESX.ShowNotification("~r~Fin de service ~n~ ~g~Vous ne receverez plus d'appel")
        end)
      end

      if data.current.value == 'bowling_outfit' then
        setUniform(data.current.value, playerPed)
        TriggerServerEvent("player:serviceOn", "bowling")
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          ESX.Game.SpawnVehicle(vehicleProps.model, vehicles.SpawnPoint, vehicles.Heading, function(vehicle)
              ...
              SetVehicleNumberPlateText(vehicle, "bowling" .. platenum)
              TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)  -- teleport into vehicle
            
          end)            

          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'bowling', vehicleProps)
...
function OpenSocietyActionsMenu()
 ...
 -- end
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'bowling_actions',
    {
      title    = _U('bowling'),
      align    = 'top-left',
      elements = elements
     ...
     --[[if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              'default', GetCurrentResourceName(), 'menu_crafting',
              {
                  ...
                  align = 'top-left',
                  elements = {
                      {label = _U('bowling1'),     value = 'reine'},
                      {label = _U('bowling2'),     value = '5fromages'},
                      {label = _U('bowling3'),     value = 'barbecue'},
                      {label = _U('bowling4'),     value = 'saumons'},
                      {label = _U('bowling5'),     value = 'orientale'},
                      {label = _U('bowling6'),     value = 'calzone'},  
                  }
              },
              function(data2, menu2)
            
                TriggerServerEvent('esx_bowlingjob:bowling1', data2.current.value)
                TriggerServerEvent('esx_bowlingjob:bowling2', data2.current.value)
                TriggerServerEvent('esx_bowlingjob:bowling3', data2.current.value)
                TriggerServerEvent('esx_bowlingjob:bowling4', data2.current.value)
                TriggerServerEvent('esx_bowlingjob:bowling5', data2.current.value)
                TriggerServerEvent('esx_bowlingjob:bowling6', data2.current.value)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(player), 'society_bowling', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_bowlingjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_bowlingjob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_bowlingjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_bowlingjob:putStockItems', itemName, count)
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_bowlingjob:getFridgeStockItems', function(items)
      ...
      function(data, menu)
        ...
        ESX.UI.Menu.Open(
          ...
          --    print("axelle")
              ...
              TriggerServerEvent('esx_bowlingjob:getFridgeStockItem', itemName, count)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_bowlingjob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_bowlingjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_bowlingjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_bowlingjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'bowling_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
          Openanim()
          TriggerServerEvent('esx_bowlingjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end)
...
AddEventHandler('esx_bowlingjob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_bowlingjob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_bowlingjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_bowlingjob:hasExitedMarker', LastZone)
            end
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'bowling', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'bowling')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu1', 'bowling', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bowling_actions') then
