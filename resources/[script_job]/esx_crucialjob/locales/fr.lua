Locales['fr'] = {
    ...
    ['crucial_outfit']             = 'Tenue Crucial fix',
    ...
    ['crucial_fridge_stock'] = 'Frigo du Crucial fix',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique de la Crucial fix',
    ...
    ['crucial_stock']            = 'Stock Crucial fix',
    ...
    -- Crafting Menu  
    ['crafting']                = 'Fabrication Crucial fix',
    ['nachos']                  = 'Poulet roti',
    ['tacos']                   = 'Poulet au curry',
    ['buritto']                 = 'Boeuf roti',
    ['salade']                  = 'salade',
    ['donuts']                  = 'Donuts',
    ['soda']                    = 'Boisson',
    ['tea']                    = 'Thé',
    ['chocolate']               = 'Tablette de chocolat',
    ['coca']                    = 'Coca Cola',
    ['frite']                   = 'Frite',
    ['icetea']                  = 'Ice tea',
    ['bolchips']                = 'Chips',
    ...
    ['not_enough']              = 'Pas assez ~r~d\'argent dans l\'entreprise',
    ['craft']                   = '~g~ est prêt',
    -- Misc  
    ['map_blip']                = 'Crucial fix',
    ['crucial']                 = 'Crucial fix',
    -- Phone  
    ['crucial_phone']           = 'Crucial fix',
    ['crucia_customer']         = 'Citoyen',
