...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'crucial' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function setUniform(job, playerPed)
  TriggerEvent('skinchanger:getSkin', function(skin)
    ...
    if skin.sex == 0 then
      ...
      if job ~= 'citizen_wear' and job ~= 'crucial_outfit' then
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('crucial_outfit'),    value = 'crucial_outfit'},
  }
    ...
    function(data, menu)
      ...
      if data.current.value == 'citizen_wear' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
          ...
          print("SERVICE OFF")
          TriggerServerEvent("player:serviceOff", "crucial")
          ESX.ShowNotification("~r~Fin de service ~n~ ~g~Vous ne receverez plus d'appel")
        end)
      end

      if data.current.value == 'crucial_outfit' then
        setUniform(data.current.value, playerPed)
        TriggerServerEvent("player:serviceOn", "crucial")
        ESX.ShowNotification("~g~Prise de service ~n~ ~r~Vous recevez les appel")
        isBarman = true
      end
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          ESX.Game.SpawnVehicle(vehicleProps.model, vehicles.SpawnPoint, vehicles.Heading, function(vehicle)
              ...
              SetVehicleNumberPlateText(vehicle, "Crucial" .. platenum)
              TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)  -- teleport into vehicle
            
          end)            

          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'crucial', vehicleProps)
...
function OpenSocietyActionsMenu()
 ...
 -- end
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'crucial_actions',
    {
      title    = _U('crucial'),
      align    = 'top-left',
      elements = elements
     ...
     --[[if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              'default', GetCurrentResourceName(), 'menu_crafting',
              {
                  ...
                  align = 'top-left',
                  elements = {
                      {label = _U('crucial1'),     value = 'reine'},
                      {label = _U('crucial2'),     value = '5fromages'},
                      {label = _U('crucial3'),     value = 'barbecue'},
                      {label = _U('crucial4'),     value = 'saumons'},
                      {label = _U('crucial5'),     value = 'orientale'},
                      {label = _U('crucial6'),     value = 'calzone'},  
                  }
              },
              function(data2, menu2)
            
                TriggerServerEvent('esx_crucialjob:crucial1', data2.current.value)
                TriggerServerEvent('esx_crucialjob:crucial2', data2.current.value)
                TriggerServerEvent('esx_crucialjob:crucial3', data2.current.value)
                TriggerServerEvent('esx_crucialjob:crucial4', data2.current.value)
                TriggerServerEvent('esx_crucialjob:crucial5', data2.current.value)
                TriggerServerEvent('esx_crucialjob:crucial6', data2.current.value)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(player), 'society_crucial', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_crucialjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_crucialjob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_crucialjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_crucialjob:putStockItems', itemName, count)
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_crucialjob:getFridgeStockItems', function(items)
      ...
      function(data, menu)
        ...
        ESX.UI.Menu.Open(
          ...
          --    print("axelle")
              ...
              TriggerServerEvent('esx_crucialjob:getFridgeStockItem', itemName, count)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_crucialjob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_crucialjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_crucialjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_crucialjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'crucial_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
          Openanim()
          TriggerServerEvent('esx_crucialjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end)
...
function Openanim()
  ...
  ESX.ShowNotification("~r~Preparation en cours ...")
  Citizen.Wait(9000)
  ClearPedTasks(playerPed)
end


AddEventHandler('esx_crucialjob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_crucialjob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_crucialjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_crucialjob:hasExitedMarker', LastZone)
            end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'menu_shop' then
            ESX.ShowNotification("~o~Ouvrez votre calculatrice")
            ESX.ShowNotification("~b~Boisson 8$ ~n~ Café 5$ ~n~ Thé 5$ ~n~ Chocolat 10$ ~n~ Sandwich 15$ ~n~ Poulet et Boeuf 20$ ~n~ Salade 15$ ~n~ Donuts 10$")
            Wait("5000")
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'crucial', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'crucial')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu1', 'crucial', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'crucial_actions') then
