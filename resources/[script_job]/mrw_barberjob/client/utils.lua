...
function GetMaxVals()
    ...
    if closestPlayer ~= -1 and closestDistance <= 2.8 then

	local playerPed = closestPlayer
...
RegisterNetEvent('mrw_barberjob:retourSync')
AddEventHandler('mrw_barberjob:retourSync', function(skin)
