...
----markers
AddEventHandler('esx_carshowroom:hasEnteredMarker', function (zone)
...
AddEventHandler('esx_carshowroom:hasExitedMarker', function (zone)
...
Citizen.CreateThread(function ()
  while true do
    ...
    if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
      ...
      TriggerEvent('esx_carshowroom:hasEnteredMarker', currentZone)
    end

    if not isInMarker and HasAlreadyEnteredMarker then
      HasAlreadyEnteredMarker = false
      TriggerEvent('esx_carshowroom:hasExitedMarker', LastZone)
    end
  end
end)
