...
local function craftItem(ingredients)
	...
	TriggerServerEvent('craftbaraking:craftItem', ingredientsPrepped)
end

RegisterNetEvent('craftbaraking:openMenu')
AddEventHandler('craftbaraking:openMenu', function(playerInventory)
...
--Citizen.CreateThread(function()
	...
	--		TriggerServerEvent('craftbaraking:getPlayerInventory')
	--	end
	--end
--end)
