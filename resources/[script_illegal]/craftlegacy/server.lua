...
RegisterServerEvent('craftlegacy:getPlayerInventory')
AddEventHandler('craftlegacy:getPlayerInventory', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	if xPlayer ~= nil then
		TriggerClientEvent('craftlegacy:openMenu', _source, xPlayer.inventory)
	end
end)
...
RegisterServerEvent('craftlegacy:craftItem')
AddEventHandler('craftlegacy:craftItem', function(ingredients)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
