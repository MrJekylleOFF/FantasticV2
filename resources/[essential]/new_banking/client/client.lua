...
local bankMenu	= true
local banks = {
	{name="Banque", id=434, x=-200.955, y=-1308.913, z=31.29},
	{name="Banque", id=434, x=-1212.980, y=-330.841, z=37.787},
	{name="Banque", id=434, x=1653.49, y=4851.35, z=41.02},
...
local atms = {
	...
	{name="ATM", id=277, x=299.0, y=-588.71, z=43.29},
...
if bankMenu then
	...
	while true do
		Wait(0)
	if nearBank() then
			DisplayHelpText("~INPUT_PICKUP~ pour accèder à compte ~b~")
