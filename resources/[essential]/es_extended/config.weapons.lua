...
Config.Weapons = {
	...
	{name = 'WEAPON_RAYMINIGUN', label = "Ray Minigun", tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_RAYMINIGUN')}},
	{name = 'WEAPON_RAYCARBINE', label = "Ray Carbine", tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_RAYCARBINE')}},
	{name = 'WEAPON_RAYPISTOL', label = "Ray Pistolet", tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_RAYPISTOL')}},
