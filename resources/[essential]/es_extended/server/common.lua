...
MySQL.ready(function()
	...
	MySQL.Async.fetchAll('SELECT * FROM jobs2', {}, function(jobs2)
		...
		MySQL.Async.fetchAll('SELECT * FROM job2_grades', {}, function(job2Grades)
...
RegisterServerEvent('esx:triggerServerCallback1')
AddEventHandler('esx:triggerServerCallback1', function(name, requestId, ...)
