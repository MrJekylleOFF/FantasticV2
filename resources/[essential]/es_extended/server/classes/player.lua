function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, job, job2, loadout, name, firstname, lastname, coords)
	local self = {}
	...
	self.removeInventoryItem = function(name, count)
		...
		if item then
			...
			if newCount >= 0 then
				...
				TriggerEvent('esx:onRemoveInventoryItem1', self.source, item.name, item.count)
				self.triggerEvent('esx:removeInventoryItem1', item.name, item.count)
			end
		end
	end
	...
	self.removeWeapon = function(weaponName, ammo)
		...
		if weaponLabel then
			...
			self.triggerEvent('esx:removeInventoryItem1', weaponLabel, false, true)
		end
	end
		...
		if weapon then
			...
			if component then
				if self.hasWeaponComponent(weaponName, weaponComponent) then
					...
					self.triggerEvent('esx:removeInventoryItem1', component.label, false, true)
				end
			end
		end
	end
