...
RegisterServerEvent('esx_skin:save1')
AddEventHandler('esx_skin:save1', function(skin)
...
RegisterServerEvent('esx_skin:responseSaveSkin1')
AddEventHandler('esx_skin:responseSaveSkin1', function(skin)

  local file = io.open('resources/[esx]/skinchanger/skins.txt', "a")
