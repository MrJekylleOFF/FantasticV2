...
function OpenSaveableMenu(submitCb, cancelCb, restrict)
	...
	OpenMenu(function(data, menu)
		...
		TriggerEvent('skinchanger:getSkin', function(skin)
			TriggerServerEvent('esx_skin:save1', skin)
...
AddEventHandler('playerSpawned', function()
	...
	Citizen.CreateThread(function()
		local nom = GetPlayerName(PlayerId())
		ESX.ShowNotification('Bienvenue ~r~~n~'  ..nom.. ' ~n~~s~Sur le serveur')
...
AddEventHandler('esx_skin:requestSaveSkin', function()
	...
	TriggerEvent('skinchanger:getSkin', function(skin)
		...
		TriggerServerEvent('esx_skin:responseSaveSkin1', skin)
