...
RegisterServerEvent('dvr_tief:setVehicleOwned')
AddEventHandler('dvr_tief:setVehicleOwned', function (vehicleProps, model)
	...
	function (rowsChanged)
        TriggerEvent("Logs:ServerLog", "ID: ".._source, "ID: ".. _source .. " vien de volé un vehicule immatriculé **" ..vehicleProps.plate.."**")
		TriggerClientEvent('esx:showAdvancedNotification', _source, "Fantastic ", "~y~VOL", "~g~Tu as voler un véhicule ! ~s~~n~Immatriculation : ~y~" .. vehicleProps.plate , "CHAR_SOCIAL_CLUB", 1)
		--https://discordapp.com/api/webhooks/727547470980186166/DpcrBAt1cLpBVbjB3_pMmVhv7_0BIzimqgF0CUObmuFEOyaBqL09V_xq58sDqTUDSOYu
	end)
end)
