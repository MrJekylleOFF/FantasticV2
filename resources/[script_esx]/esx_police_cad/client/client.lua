...
Citizen.CreateThread(function()
    ...
    if GUI.PoliceCadIsShowed then -- codes here: https://pastebin.com/guYd0ht4
      ...
      DisableControlAction(0, Keys['F1'],   true) -- Select Prev Weapon
      ...
      if PlayerData.job ~= nil and ((PlayerData.job.name == 'police') or (PlayerData.job.name == 'fbi') or (PlayerData.job.name == 'bav') or  (PlayerData.job.name == 'sheriff'))then
          if IsControlPressed(0, Keys['F2']) and GetLastInputMethod(0) then
