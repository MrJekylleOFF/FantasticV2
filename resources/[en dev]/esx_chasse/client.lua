...
RegisterNetEvent("esx_chasse:createBlip2")
AddEventHandler("esx_chasse:createBlip2", function(type, x, y, z)
	local blip = AddBlipForCoord(x, y, z)
	SetBlipSprite(blip, type)
	SetBlipScale(blip, 0.8)
	SetBlipAsShortRange(blip, true)
...
Citizen.CreateThread(function()
		...
		TriggerEvent('esx_chasse:createBlip2', 141, 960.196105957031,-2105.53198242188,31.9526977539063)
       ...
       playerPed = GetPlayerPed(-1)
		...
		if pos then
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), 960.196105957031,-2105.53198242188,31.9526977539063, true) <= 5 then
					TriggerServerEvent('esx_chasse:startVente')
					Citizen.Wait(4000)
				end
