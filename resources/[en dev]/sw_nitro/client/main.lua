...
local function NitroLoop(lastVehicle)
  ...
  if isRunning and isEnabled and isFueled and ((GetEntityModel(vehicle) == GetHashKey('panamera17turbo')) or (GetEntityModel(vehicle) == GetHashKey('bmwm8')) or (GetEntityModel(vehicle) == GetHashKey('oldm6'))) then
    if isDriving then
