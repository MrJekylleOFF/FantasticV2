...
function SetVehicleNitroPurgeEnabled(vehicle, enabled)
  ...
  if enabled then
    ...
    for i=0,3 do
      local leftPurge = CreateVehiclePurgeSpray(vehicle, off.x - 0.9, off.y , off.z-0.3, 40.0, -20.0, 0.0, 0.5)
      local rightPurge = CreateVehiclePurgeSpray(vehicle, off.x + 0.9, off.y, off.z-0.3, 40.0, 20.0, 0.0, 0.5)
